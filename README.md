...
| **Watcher** | Checks configured sources on a schedule and reports only meaningful changes. |
...
The README is the front door. The [User Guide](docs/USER_GUIDE.md) is the manual.

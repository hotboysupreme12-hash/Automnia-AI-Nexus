...
const CONTROL_CENTER_GATEWAY_AGENT_SESSIONS = !/^(0|false|no)$/i.test(
  process.env.CONTROL_CENTER_GATEWAY_AGENT_SESSIONS || (MACOS_LOCAL_AGENT_RUNTIME_DEFAULT ? '0' : '1'),
)
...
const FORCE_LOCAL_AGENT_RUNTIME = /^(1|true|yes)$/i.test(
  process.env.CONTROL_CENTER_FORCE_LOCAL_AGENT_RUNTIME || (MACOS_LOCAL_AGENT_RUNTIME_DEFAULT ? '1' : ''),
)

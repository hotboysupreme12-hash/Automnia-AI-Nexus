  ...
  return [
    ...
    },
    {
      ...
      content: [
        ...
        'The upstream Agency catalog can render agents for these target tools. DystopAI Recruit preserves the source persona and converts it into OpenClaw workspace doctrine files.',
        ...toolTargetMarkdown(input.toolTargets),
        '',
        '## Native Services',
        '- DystopAI/OpenClaw recruit API',

...
const HELP_DESTINATION_MATCHES: HelpDestinationMatch[] = [
  ...
  { alias: 'Account', label: 'Account', target: 'settings-account', title: 'Open Settings at Account.' },
  { alias: 'Account & Plan', label: 'Account', target: 'settings-account', title: 'Open Settings at Account.' },
  { alias: 'Account & License', label: 'Account', target: 'settings-account', title: 'Open Settings at Account.' },
  { alias: 'Backup & Reset', label: 'Backup & Reset', target: 'settings-data', title: 'Open Settings at Backup & Reset.' },
  { alias: 'Data & reset', label: 'Backup & Reset', target: 'settings-data', title: 'Open Settings at Backup & Reset.' },
  ...
  { alias: 'Agent Behavior', label: 'Agent Behavior', target: 'settings-agents', title: 'Open Settings at Agent Behavior.' },
  { alias: 'Agent runtime', label: 'Agent Behavior', target: 'settings-agents', title: 'Open Settings at Agent Behavior.' },
  { alias: 'Runtime settings', label: 'Agent Behavior', target: 'settings-agents', title: 'Open Settings at Agent Behavior.' },

...
export const ADMIN_GCLOUD_CONFIG = {
  provisionerUrl: 'https://automnia-shopify-provisioner-6abxlp2t4q-ue.a.run.app',
  shopifyWebhookBaseUrl: 'https://automnia-shopify-provisioner-6abxlp2t4q-ue.a.run.app/shopify/webhooks',

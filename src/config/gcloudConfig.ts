...
export const ADMIN_GCLOUD_CONFIG = {
  provisionerUrl: 'https://automnia-shopify-provisioner-gpz4bqizia-ue.a.run.app',
  shopifyWebhookBaseUrl: 'https://automnia-shopify-provisioner-gpz4bqizia-ue.a.run.app/shopify/webhooks',

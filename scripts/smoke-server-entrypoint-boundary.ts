...
assert.match(runtimeStatusService, /readRuntimeGatewayLedgerSnapshot\(160, \{ sqlite: false \}\)/, 'runtime status service should use the non-blocking Gateway ledger snapshot for full status')
assert.match(runtimeStatusService, /readRuntimeGatewayLedgerSnapshot\(48, \{ sqlite: false \}\)/, 'runtime status service should use the non-blocking Gateway ledger snapshot for summaries')

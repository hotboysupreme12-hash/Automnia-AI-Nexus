...
try {
  ...
  assert.match(serverSource, /app\.get\('\/api\/missions\/:missionId\/events'/)
  assert.match(serverSource, /app\.get\('\/api\/missions\/:missionId\/report'/)
  ...
  assert.match(serverSource, /app\.get\('\/api\/missions\/projection'/, '/api/missions/projection must expose durable mission state')

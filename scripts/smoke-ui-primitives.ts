...
assert.match(statusChip, /<span className="dui-status-chip__label">\{label\}<\/span>/, 'StatusChip should render a visible state label')
assert.match(statusChip, /<span className="dui-status-chip__value">\{visibleValue\}<\/span>/, 'StatusChip should render a visible state value')

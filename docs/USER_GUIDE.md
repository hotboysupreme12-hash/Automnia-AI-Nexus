...
| Plan | Access policy |
| --- | --- |
| Starter | 22,000 Automnia credits backed by 22,000,000 hosted tokens for essential hosted models, agents, and workflows. This straightforward plan uses Automnia credits only. |
| Pro | 55,000 Automnia credits backed by 55,000,000 hosted tokens plus every advanced capability formerly offered in Enterprise: all Automnia models and workflows, provider connections, offline-capable provider access, and configurable provider/credit fallback routing. |
